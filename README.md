...
# Installation
1. Set up Shopify:
    1. Set up a Shopify store and enable the [Buy Button Channel](https://www.shopify.com/buy-button). ![Screenshot of the Shopify Add Channel button](https://raw.githubusercontent.com/funkhaus/wp-shopify/master/docs/add-channel-button.png) ![Screenshot of the "Add Buy Button Channel" dialog](https://raw.githubusercontent.com/funkhaus/wp-shopify/master/docs/add-buy-button.png)
